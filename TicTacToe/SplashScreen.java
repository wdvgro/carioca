...
public class SplashScreen {
    ...
    public SplashScreen() {
        window = new JWindow();
        var originalImage = new ImageIcon("C:\\Users\\Mbhst\\IdeaProjects\\TestEnv\\src\\images\\GameLogo3.png").getImage(); // replace this with your game logo path
    ...
    public void hide() {
        ...
        // After hiding SplashScreen, open ServerConnectScreen
